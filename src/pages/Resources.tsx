    ...
    <div className="py-20 px-4">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="text-center mb-16">
          <span className="inline-flex items-center gap-2 rounded-full bg-amber-600/10 px-4 py-1.5 text-sm font-medium text-amber-700 dark:bg-amber-400/10 dark:text-amber-300 mb-4">
        ...
        <div className="group bg-gradient-to-br from-amber-50 to-orange-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl p-8 mb-12 border border-amber-200 dark:border-amber-800/30 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
            <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-lg group-hover:scale-110 transition-transform">
              <svg className="w-10 h-10 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
            </div>
            <div className="flex-1">
              <h2 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white group-hover:text-amber-600 transition-colors">
            ...
            <a href="#" className="px-6 py-3 bg-amber-600 text-white rounded-xl hover:bg-amber-700 hover:shadow-lg transition-all whitespace-nowrap">
              Download PDF →
            </a>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {/* Documentation */}
          <div className="group bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-gray-200 dark:border-gray-700">
            <div className="mb-4 group-hover:scale-110 transition-transform">
              <svg className="w-10 h-10 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
            </div>
            <h3 className="text-lg font-semibold mb-2 text-gray-900 dark:text-white group-hover:text-amber-600 transition-colors">
