...
export default function TopNav({ lockdown, onMenuClick }: TopNavProps) {
  ...
  return (
    <header className={`fixed top-0 right-0 left-0 md:left-64 h-16 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 z-30 transition-all duration-300 ${lockdown ? 'mt-8' : ''}`}>
